		...
		<div>
			...
			<div className="row pg3-sec1 m-0">
				...
				<div className="col-md-6 p-0 align-items-center d-flex flex-column pg3-sec1-right">
					<h4 className="pg3-right-heading my-4">Red Roses Mailbox</h4>
					...
					<div className="klara-wrapper">
						<img src={Klara}></img>
						<span className="ml-3 klara-text">Köp nu betalar senare</span>
					</div>
					<div className="sec4-cart-btn-wrapper mt-3 row w-100">
						<div className="col-md-6 d-flex align-items-center pg3-float-right">
							<button className="pg3-cal-btn" onClick={decrementCount1}>
								<i className="fa-solid fa-minus"></i>
							</button>
							<span className="pg3-cal-text mx-3">{count1}</span>
							<button className="pg3-cal-btn" onClick={incrementCount1}>
								<i className="fa-solid fa-plus"></i>
							</button>
						</div>
						<div className="col-md-6 pg3-float-center">
							<button className="my-4 ml-3 d-flex pg3-right-btn">
								<img src={Bag} className="mr-2"></img>
					...
					<div className="d-flex align-items-center justify-content-center">
						...
						<span className=" ml-3 klara-text">
