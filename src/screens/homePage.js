...
export default function HomePage() {
	...
	return (
		<div>
				...
				<div className="row align-items-center flex-row-reverse">
					...
					<div className="col-lg-5">
						<div className="sec2-card shadow">
							<h4 className="sec1-heading mt-4 mb-3 font-700">Reste sig</h4>
							<span className="my-1 sec2-text">
			...
			<div className="sec-padding">
				<h2 className="sec2-heading text-center mb-3">
					Skicka blommor till brevlådan
				</h2>
				<div className="cards-category-wrapper">
					<span className="cards-title-text">Alla blomgåvor</span>
					<span className="cards-title-text">Födelsedagsgåvor</span>
					<span className="cards-title-text">Färska blomgåvor</span>
					<span className="cards-title-text">Torkade blomgåvor</span>
				</div>
				<div className="row align-items-center text-center">
					<div className="col-lg-4 col-md-6 my-3">
						<div className="sec3-card shadow">
							...
							<h4 className="sec3-card-heading mt-4 mb-2"> Hibiskus</h4>
							<span className="my-1">
							...
							<button className="sec3-card-btn mt-4">Beställ nu</button>
						</div>
					</div>
					<div className="col-lg-4 col-md-6 my-3">
						<div className="sec3-card shadow">
			...
			<div className="sec-padding pt-1 text-center">
				<div className="sec4-dropdown-wrapper">
					...
					<div className="dropdown">
						<button
							className="btn dropdown-toggle secc4-drop-btn shadow2"
							type="button"
				...
				>
						...
						<div className="carousel-item active border-0 sec4-carousel-item">
							<div className="row sec4-row">
								<div className="col-lg-4 col-md-6 sec4-left-col">
									...
									<h5 className="sec4-caption mt-5 mb-4">HJÄRTSTRÄNGAR</h5>
								...
								<div className="col-lg-4 col-md-6 sec4-right-col">
									...
									<h5 className="sec4-caption mt-5 mb-4">THALITE</h5>
									<span className="sec4-price">$45.00/Bit</span>
									<div className="sec4-cart-btn-wrapper mt-3">
					...
					<button
						className="carousel-control-prev sec2-carousel-btn shadow2"
					...
					<button
						className="carousel-control-next sec2-carousel-btn shadow2"
						href="#carouselExample2"
						data-slide="next"
					>
						<img src={Right}></img>
			...
			<div className="sec10">
				...
				<div className="row sec10-row">
					<div className="col-md-7 sec10-left text-center">
						...
						<div className="sec-10-input-wrapper">
							...
							<textarea
								...
								rows="10"
							/>
							<button className="sec10-btn my-4 sec-10-btn">Skicka in</button>
						</div>
					</div>
					<div className="col-md-4 sec-10-right">
						<span className="sec10-input-head mb-4">Kontakttider</span>
						<span className="sec2-text mb-3 font-500">
							Mån-Fre 08:00 - 19:00
						</span>
						<span className="sec2-text mb-5 font-500">
							Lör-Sön 10:00 – 13:00
						</span>
						<span className="sec10-input-head mt-4 mb-4">Skicka ett email</span>
						<span className="sec2-text mb-4 d-flex font-400">
						...
						<span className="sec2-text d-flex font-400">
